...
class pdfgenerator:
    ...
    def convert_json_to_pdf_buffer(self, Data: dict) -> BytesIO:
        ...
        # self.total_lines += title_lines  # You can keep this if you want to count title lines
        ...
        print(f"Total number of lines in the document (excluding headings): {self.total_lines}")
